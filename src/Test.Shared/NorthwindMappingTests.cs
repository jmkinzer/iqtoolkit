...
namespace Test
{
    ...
    [TestClass]
#endif
    public partial class NorthwindMappingTests : TestBase
    {
        class TestAttributes_Column_Basics_Types
        {
        ...
        [TestMethod]
        public void TestAttributes_Column_Basics()
        {
            TestProvider(
                new AttributeMapping(),
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Column_Basics_Types.Customer>()
                        .ToList();
                    ...
                    foreach (var item in items)
                    {
                        ...
                        Assert.AreNotEqual(null, item.Name);
                        Assert.AreNotEqual(null, item.Phone);
                    }
                });
        }


        class TestAttributes_Column_Context_Types
        {
            public class Customer
            {
                public string ID;
        ...
        [TestMethod]
        public void TestAttributes_Column_Context()
        {
            TestProvider(
                new AttributeMapping(typeof(TestAttributes_Column_Context_Types.Context)),  
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Column_Context_Types.Customer>()
                        .ToList();
        ...
        class TestAttributes_Table_NameInferred_Types
        {
            public class Customer
            {
                public string ID;
        ...
        [TestMethod]
        public void TestAttributes_Table_NameInferred()
        {
            TestProvider(
                new AttributeMapping(typeof(TestAttributes_Table_NameInferred_Types.Context)),
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Table_NameInferred_Types.Customer>().ToList();
        ...
        class TestAttributes_Table_Inferred_Types
        {
            public class Customer
            {
                public string ID;
        ...
        [TestMethod]
        public void TestAttributes_Table_Inferred()
        {
            TestProvider(
                new AttributeMapping(typeof(TestAttributes_Table_Inferred_Types.Context)),
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Table_Inferred_Types.Customer>().ToList();
        ...
        class TestAttributes_Entity_RuntimeType_Types
        {
            [Entity(ConstructedType = typeof(RuntimeCustomer))]
            [Table(Name = "Customers")]
        ...
        [TestMethod]
        public void TestAttributes_Entity_RuntimeType()
        {
            TestProvider(
                new AttributeMapping(),
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Entity_RuntimeType_Types.ICustomer>()
                        .ToList();
        ...
        class TestAttributes_Entity_RuntimeType_Context_Types
        {
            public interface ICustomer
            {
                string ID { get; set; }
            ...
            public abstract class Context
            {
                [Entity(ConstructedType = typeof(RuntimeCustomer))]
                [Table(Name = "Customers")]
                [Column(Member = "ID", Name = "CustomerID")] // legal to have context property preceding
                [Column(Member = "Name", Name = "ContactName")]
        ...
        [TestMethod]
        public void TestAttributes_Entity_RuntimeType_Context()
        {
            TestProvider(
                new AttributeMapping(typeof(TestAttributes_Entity_RuntimeType_Context_Types.Context)),
                provider =>
                {
                    var items = provider.GetTable<TestAttributes_Entity_RuntimeType_Context_Types.ICustomer>().ToList();
